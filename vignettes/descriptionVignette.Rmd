...
The `` bracketpredic`tr `` package provides a set of functions for analyzing Division I college basketball stats, from 2013 to 2019. With this package, you can easily retrieve team and game stats for a given season (or multiple), predict winners of upcoming games, and more.
