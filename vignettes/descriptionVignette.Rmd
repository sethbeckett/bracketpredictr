---
title: "descriptionVignette"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{descriptionVignette}
...
The bracketpredictr package provides a set of functions for analyzing division I college basketball stats, from 2013 to 2019. With this package, you can easily retrieve team and game stats for a given season, predict winners of upcoming games, and move.
...
To retrieve team stats for one or more teams, you can use the get_teams_stats function:
...
get_teams_stats(teams, stats, years)
```

This will output a table showing the requested stats for the specified teams and years. \### Predicting game winners To predict the winner of a game between two teams, you can use the predict_winner function:
